...
%   
%
function R_test(fbsCount, NumRealization)
...
%             R = K - (fbs.C_FUE-q_M)^2;
            beta = FBS{1,1}.dMUE/dth;
            R = beta*FBS{1,1}.C_FUE - (FBS{1,1}.C_FUE-2.0)^2;
...
%         end
    ...
    QFinal = answer;
    save(sprintf('Results/R_test6:%d,Real:%d.mat',fbsCount, NumRealization),'QFinal');
