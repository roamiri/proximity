...
%
function Q = PA_RL_ref(mueNumber,fbsCount,femtocellPermutation, NumRealization,QTable, saveNum)
...
for i=1:fbsCount
    ...
    selectedMUE.SINR = SINR_MUE_4(G, L, FBS, MBS, selectedMUE, -120);
    ...
    for episode = 1:Iterations
        ...
        selectedMUE = selectedMUE.setCapacity(log2(1+SINR_MUE_4(G, L, FBS, MBS, selectedMUE, -120)));
