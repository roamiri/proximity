...
%   
%
function Q = R_Nopunish_2(fbsCount, NumRealization, QTable)
...
%         R = K - dum2*dum1;
        for j=1:size(FBS,2)
            ...
            if (check_fue==0 && check_mue==0)
                ...
                R = beta*fbs.C_FUE*mue(1).C - (1/beta)*dum1*dum2;
            end
...
%         end
    ...
    QFinal = answer;
    save(sprintf('nopunish/R_nopunish_2:%d,Real:%d.mat',fbsCount, NumRealization),'QFinal');
