...
%   
%
function R_multi4(fbsCount, NumRealization)
...
%             R = K - deviation_MUE - (fbs.C_FUE-q_M)^2;
            ...
            if mue(1).C >= q_N
                ...
                if fbs.C_FUE >= q_M
                    ...
                    R = K -(fbs.C_FUE-q_M)^2 -(mue(1).C-q_N)^2;
                end
            end
%             if R<0
%                 R=0;
...
%         end
    ...
    QFinal = answer;
    save(sprintf('Results/R_multi(0-25)-Inside:%d,Real:%d.mat',fbsCount, NumRealization),'QFinal');
